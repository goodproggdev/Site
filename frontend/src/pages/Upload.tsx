    ...
    <Modal show={isOpen} onClose={onClose} size="md"> {/* Puoi regolare la dimensione del modal */}
      ...
      <Modal.Body className="overflow-y-auto max-h-[80vh]"> {/* Aggiungi scroll al body */}
        <form className="max-w-sm mx-auto" onSubmit={handleSubmit}>
           ...
           {/* Questi campi saranno popolati automaticamente se il parser li trova */}
            <div className="mb-5">
          ...
          <div className="mb-5 mt-10 border-t pt-4">
           ...
           {/* Esempio per skills (solo i campi name e level) */}
            <div className="mb-5 mt-10 border-t pt-4">
             ...
             {formData.skills.map((item, index) => (
                 <div key={index} className="mb-4 p-3 border rounded-lg dark:border-gray-700 relative flex items-center space-x-4">
                    ...
                    <div className="flex-grow">
                         <label htmlFor={`skills_${index}_name`} className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Skill Name</label>
                         <input
                            type="text"
                     ...
                     <div className="flex-grow">
                         <label htmlFor={`skills_${index}_level`} className="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Level</label>
                         <input
                            type="text"
